        ...
        <div>
                ...
                <div style={{ width: "50vw", height: "600px", background: "white", display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <div style={{ width: "445px", height: "285px", display: "flex", justifyContent: "space-between", alignItems: "start", flexDirection: "column" }} >
                        ...
                        <div style={{ width: "137px", height: "25px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", position: "relative" }}>
                            <div style={{ width: "120px", height: "25px", fontFamily: '"Fraunces", serif', fontWeight: "900", fontSize: "15px", lineHeight: "25px", zIndex: "0" }}>LEARN MORE</div>
                            <div className='line1' style={{ height: "10px", width: "137px", borderRadius: "28px", position: "absolute", top: "65%", cursor: "pointer" }}></div>
                        </div>
                    </div>
                </div>
                <img
                ...
                <div style={{ width: "50vw", height: "600px", background: "white", display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <div style={{ width: "445px", height: "285px", display: "flex", justifyContent: "space-between", alignItems: "start", flexDirection: "column" }} >
                        ...
                        <div style={{ width: "137px", height: "25px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", position: "relative" }}>
                            ...
                            <div className='line2' style={{ height: "10px", width: "137px", borderRadius: "28px", position: "absolute", top: "65%", cursor: "pointer" }}></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{ width: "100vw", height: "350px", background: "#90D4C6", display: "flex", justifyContent: "center", alignItems: "center", gap: "40px", flexDirection: "column" }}>
                ...
                <div style={{ width: "295px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div className='footertext' style={{ fontSize: "18px", fontWeight: "600", }}>About</div>
                    <div className='footertext' style={{ fontSize: "18px", fontWeight: "600", }}>Services</div>
                    <div className='footertext' style={{ fontSize: "18px", fontWeight: "600", }}>Projects</div>
                </div>
